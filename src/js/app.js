...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const editProfileModal = new Modal(document.getElementById('editProfileModal'));
    ...
    const viewProfileModal = new Modal(document.getElementById('viewProfileModal'));
    ...
    const composeMessageModal = new Modal(document.getElementById('composeMessageModal'));
    ...
    const requestMentorshipModal = new Modal(document.getElementById('requestMentorshipModal'));
    ...
    const createTopicModal = new Modal(document.getElementById('createTopicModal'));
