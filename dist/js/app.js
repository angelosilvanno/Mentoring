...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateDashboardUI(user) {
        ...
        Object.values(navItems).forEach(item => item === null || item === void 0 ? void 0 : item.classList.add('d-none'));
        if (user.role === 'mentee') {
            (_a = navItems.buscar) === null || _a === void 0 ? void 0 : _a.classList.remove('d-none');
            (_b = navItems.agendamentos) === null || _b === void 0 ? void 0 : _b.classList.remove('d-none');
            (_c = navItems.mensagens) === null || _c === void 0 ? void 0 : _c.classList.remove('d-none');
            (_d = navItems.forum) === null || _d === void 0 ? void 0 : _d.classList.remove('d-none');
            switchView('buscar-mentores-section');
        }
        else if (user.role === 'mentor') {
            (_e = navItems.agendamentos) === null || _e === void 0 ? void 0 : _e.classList.remove('d-none');
            (_f = navItems.mensagens) === null || _f === void 0 ? void 0 : _f.classList.remove('d-none');
            (_g = navItems.forum) === null || _g === void 0 ? void 0 : _g.classList.remove('d-none');
            switchView('agendamento-section');
        }
        else if (user.role === 'admin') {
            (_h = navItems.admin) === null || _h === void 0 ? void 0 : _h.classList.remove('d-none');
    ...
    function handleLogin(e) {
        ...
        const loginIdentifier = target.querySelector('input[name="loginIdentifier"]').value;
        const password = target.querySelector('input[type="password"]').value;
        const foundUser = users.find(user => (user.email === loginIdentifier || user.username === loginIdentifier) &&
    ...
    function buildMentorCard(mentor) {
        const allRatings = appointments
            .filter(a => { var _a; return a.mentorId === mentor.id && ((_a = a.feedback) === null || _a === void 0 ? void 0 : _a.rating); })
    ...
    function renderFeaturedMentors() {
        ...
        const mentorsWithRatings = users
            ...
            .map(mentor => {
            const allRatings = appointments.filter(a => { var _a; return a.mentorId === mentor.id && ((_a = a.feedback) === null || _a === void 0 ? void 0 : _a.rating); }).map(a => a.feedback.rating);
            const averageRating = allRatings.length > 0 ? allRatings.reduce((a, b) => a + b, 0) / allRatings.length : 0;
            return Object.assign(Object.assign({}, mentor), { averageRating, ratingCount: allRatings.length });
        })
    ...
    function initCalendar() {
        ...
        calendar = new Calendar(calendarContainer, {
            ...
            eventClick: function (info) {
                ...
                <p><strong>Data:</strong> ${(_a = info.event.start) === null || _a === void 0 ? void 0 : _a.toLocaleString('pt-BR', { dateStyle: 'full', timeStyle: 'short' })}</p>
